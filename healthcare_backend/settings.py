...
SECRET_KEY = config('SECRET_KEY', default="django-insecure-vo7n3y6)#8!@7)t0!z!!5_=dplkoclw6$v@gzhlo1d=9f6n6%%")
...
# PostgreSQL Configuration (ACTIVE - Neon)
DATABASES = {
    "default": {
...
# SQLite Configuration (backup - uncomment to use SQLite)
# DATABASES = {
#     "default": {
